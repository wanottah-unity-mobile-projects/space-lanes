...
public class PurpleShipBottomController : MonoBehaviour
{
    ...
    {
        shipRigidbody.velocity = GameController.gameController.purpleShipSpeed * Time.deltaTime * shipDirection;
